<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Aromakart.User.Payment" %>
                        ...
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3"> 
                                    <li class="nav-item"><a data-toggle="pill" href="#debit-card" class="nav-link active"><i class="fa fa-credit-card mr-2"></i>Debit Card </a></li>&nbsp&nbsp
                                    <li class="nav-item"><a data-toggle="pill" href="#cod" class="nav-link active "><i class="fa fa-money-bill-alt mr-2"></i>Cash On Delivery </a></li>
                            ...
                            <div class="tab-content">
                                <!-- credit card info-->
                                <div id="debit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                ...
                                <div class="card-footer">
    <asp:Label runat="server" ID="lblOption" CssClass="subscribe badge badge-danger b-label  shadow-sm">OR You can Chose Cash On Delivery</asp:Label>
</div>
                                <!-- End -->
                                <!-- Cash On Delivery info -->
                                <div id="cod" class="tab-content show active fade pt-3">
                                    <div class="form-group">
